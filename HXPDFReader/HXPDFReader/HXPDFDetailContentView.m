...
@interface HXPDFDetailContentView () <UIScrollViewDelegate>

@end

@implementation HXPDFDetailContentView
{
    UIView *theContainerView;
    
    UIUserInterfaceIdiom userInterfaceIdiom;
    
    HXPDFDetailContentPage *theContentPage;
    
    HXPDFReaderContentThumb *theThumbView;
...
- (instancetype)initWithFrame:(CGRect)frame document:(HXPDFDocument *)document page:(NSUInteger)page
{
    if ((self = [super initWithFrame:frame]))
    {
        ...
        theContentPage = [[HXPDFDetailContentPage alloc] initWithDocument:document page:page];
        ...
        if (theContentPage != nil) // Must have a valid and initialized content page
        {
            ...
            theThumbView = [[HXPDFReaderContentThumb alloc] initWithFrame:theContentPage.bounds]; // Page thumb view
...
- (void)showPageThumbWithDocument:(HXPDFDocument *)document page:(NSInteger)page
{
    ...
    HXPDFReaderThumbRequest *request = [HXPDFReaderThumbRequest newForView:theThumbView document:document page:page size:size];
    
    UIImage *image = [[HXPDFReaderThumbCache sharedInstance] thumbRequest:request priority:YES]; // Request the page thumb
    
    if ([image isKindOfClass:[UIImage class]]) {
        [theThumbView showImage:image]; // Show image from cache
    }
}
...
//
//    HXPDFReaderContentThumb class implementation
//

@implementation HXPDFReaderContentThumb

#pragma mark - HXPDFReaderContentThumb instance methods
