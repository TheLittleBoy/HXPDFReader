...
#pragma mark - HXPDFReaderThumbRender instance methods
...
- (void)main
{
	...
	if (imageRef != NULL) // Create UIImage from CGImage and show it, then save thumb as PNG
	{
		...
		[[HXPDFReaderThumbCache sharedInstance] setObject:image forKey:request.cacheKey]; // Update cache
